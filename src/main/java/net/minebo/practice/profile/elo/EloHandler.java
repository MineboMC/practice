package net.minebo.practice.profile.elo;
...
import net.minebo.practice.profile.elo.listener.EloLoadListener;
import net.minebo.practice.profile.elo.listener.EloUpdateListener;
import net.minebo.practice.profile.elo.repository.EloRepository;
...
public final class EloHandler {
    ...
    public void resetElo(final UUID player) {
        Bukkit.getLogger().info("Resetting elo of " + Practice.getInstance().getUuidCache().name(player) + ".");
        Bukkit.getScheduler().runTaskAsynchronously(Practice.getInstance(), () -> {
