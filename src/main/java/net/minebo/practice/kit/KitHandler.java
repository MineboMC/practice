...
import net.minebo.practice.kit.listener.KitEditorListener;
import net.minebo.practice.kit.listener.KitItemListener;
import net.minebo.practice.kit.listener.KitLoadListener;
...
public final class KitHandler {
    ...
    public KitHandler() {
        Bukkit.getPluginManager().registerEvents(new KitEditorListener(), Practice.getInstance());
        Bukkit.getPluginManager().registerEvents(new KitItemListener(), Practice.getInstance());
    ...
    public void saveKitsAsync(Player player) {
        Bukkit.getScheduler().runTaskAsynchronously(Practice.getInstance(), () -> {
            ...
            List kitJson = (List) JSON.parse(Practice.getGson().toJson(kitData.getOrDefault(player.getUniqueId(), ImmutableList.of())));
