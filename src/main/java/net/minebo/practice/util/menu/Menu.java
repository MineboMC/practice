...
public abstract class Menu {
    ...
    private Inventory createInventory(Player player) {
        ...
        final Inventory inventory = Practice.getInstance().getServer().createInventory(player, size(player), getTitle(player));
    ...
    private void update(Player player) {
        ...
        runnable.runTaskTimer(Practice.getInstance(), 10L, 10L);
