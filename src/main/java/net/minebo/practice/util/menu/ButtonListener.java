    ...
    public void onButtonPress(InventoryClickEvent event) {
        ...
        if (openMenu != null) {
            ...
            if (openMenu.getButtons().containsKey(event.getSlot())) {
                ...
                player.setMetadata("CLICKED_BUTTON",new FixedMetadataValue(Practice.getInstance(),player.getUniqueId().toString()));
                ...
                if (event.isCancelled()) {
                    Practice.getInstance().getServer().getScheduler().runTaskLater(Practice.getInstance(), player::updateInventory, 1L);
                }

                player.removeMetadata("CLICKED_BUTTON", Practice.getInstance());
