...
public final class PlayerUtils {
    ...
    public static void animateDeath(Player player, Player watcher) {
        ...
        try {
            ...
            Practice.getInstance().getServer().getScheduler().runTaskLater(Practice.getInstance(), () -> ((CraftPlayer)watcher).getHandle().playerConnection.sendPacket(new PacketPlayOutEntityDestroy(entityId)), 40L);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
