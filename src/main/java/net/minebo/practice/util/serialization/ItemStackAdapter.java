package net.minebo.practice.util.serialization;
    ...
    public static JsonElement serialize(ItemStack item) {
        ...
        if (item.hasItemMeta()) {
            ...
            if (meta instanceof LeatherArmorMeta) {
                ...
                for ( final Entry<Enchantment, Integer> entry : ((EnchantmentStorageMeta) meta).getStoredEnchants().entrySet() ) {
        ...
        if (item.getEnchantments().size() != 0) {
            ...
            for ( final Entry<Enchantment, Integer> entry2 : item.getEnchantments().entrySet() ) {
