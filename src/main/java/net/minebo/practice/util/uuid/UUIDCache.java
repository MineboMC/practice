package net.minebo.practice.util.uuid;

import lombok.Getter;
import net.minebo.practice.Practice;
import net.minebo.practice.util.uuid.bukkit.BukkitUUIDCache;
import net.minebo.practice.util.uuid.listener.UUIDListener;
...
public final class UUIDCache implements IUUIDCache {
    ...
    public void monitor(String message) {
        MONITOR_CACHE.keySet().forEach(uuid -> {
            ...
            final Player player = Practice.getInstance().getServer().getPlayer(uuid);
